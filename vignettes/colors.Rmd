...
On iOS, each palette is accompanied by an accessible variant as well where the temperature and transparency were adjusted to provide higher contrast. Both light and dark palettes can be used with [sfthemes::theme_sf_light] and `theme_sf_dark` themes. 
