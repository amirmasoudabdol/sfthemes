...
On iOS, each palette is accompanied by an accessible variant as well where the temperature and transparency were adjusted to provide higher contrast. Both light and dark palettes can be used with `theme_sf_light` and `theme_sf_dark` themes. 

**iOS Light Palette**
![iOS Light](../../man/figures/ios_light.png)

**iOS Accessible Light Palette**
![iOS Light Accessible](../../man/figures/ios_light_accessible.png)
...
**macOS Light Palette**
![macOS Light](../../man/figures/macos_light.png)

**macOS Vibrant Light Palette**
![macOS Light Accessible](../../man/figures/macos_light_vibrant.png)
...
![watchOS Dark](../../man/figures/watchos_dark.png)
...
![](../../man/figures/ios_light_contrast.png)

**macOS palette ordered for more in-between contrast**
![](../../man/figures/macos_light_contrast.png)