...
elements, as mentioned, sfthemes can scale fonts, elements, or both at the same time. Moreover, the rescaling effect can be previewed as you experiment with your plot.
...
Using `element_size_class` parameter, we can control the scaling of the **elements**. 
...
Using `font_size_class` parameter, we can control the scaling of the **fonts**.
...
Using `size_class` parameter, we can control the scaling of the **elements**.
